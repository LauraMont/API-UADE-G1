...
public class LocactionController {
    ...
    @PostMapping
    public ResponseEntity<LocacionRequest> createLocation(@RequestBody LocacionRequest locacionRequest) throws CategoryDuplicateException {
        LocacionRequest result = locacionService.createLocacion(locacionRequest.getNombre(), locacionRequest.getDireccion(), locacionRequest.getCapacidad_total(), locacionRequest.getZonas());
